          ...
          child: Column(
            ...
            children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(
                          context,
                        ).getText('z7s2r5z2' /* Мы отправили код на */),
                      ...
                      Text(
                        valueOrDefault<String>(widget.phone, 'Номер не указан'),
                        style: FlutterFlowTheme.of(context).bodyLarge.override(
                          font: GoogleFonts.jetBrainsMono(
              ...
              PinCodeTextField(
                ...
                validator: _model.pinCodeControllerValidator.asValidator(
                  context,
                ),
              ),
              Align(
                    ...
                    onPressed: _isVerifying || !_rulesAccepted
                        ...
                        : () async {
                            ...
                            if (smsCodeVal.length != phoneAuthCodeLength) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Введите четырёхзначный код.'),
                                ),
                              );
                              return;
                            }
                            ...
                            try {
                              ...
                              final signedInFirebaseUser =
                                  FirebaseAuth.instance.currentUser;
                              if (signedInFirebaseUser != null) {
                                // Firebase Auth may already have completed even
                                // if the following profile read was interrupted.
                                await maybeCreateUser(signedInFirebaseUser);
                                phoneVerifiedUser = currentUser;
                              } else {

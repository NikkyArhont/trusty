...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF6B7280);
  ...
  late Color accent1 = const Color(0xFF22C55E);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF8F22C5);
  ...
  late Color divider = const Color(0xFFE5E7EB);
}
...
class ThemeTypography extends Typography {
  ...
  String get labelLargeFamily => 'JetBrains Mono';
  ...
  String get labelMediumFamily => 'JetBrains Mono';
  bool get labelMediumIsCustom => false;
  TextStyle get labelMedium => GoogleFonts.jetBrainsMono(
        color: theme.secondaryText,
        fontWeight: FontWeight.normal,
        fontSize: 14.0,
      );
  String get labelSmallFamily => 'JetBrains Mono';
  ...
  String get bodyLargeFamily => 'JetBrains Mono';
  ...
  String get bodyMediumFamily => 'JetBrains Mono';
  ...
  String get bodySmallFamily => 'JetBrains Mono';
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF475569);
  ...
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF8B4ADE);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF22C55E);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFF87171);
  late Color info = const Color(0x82000000);
